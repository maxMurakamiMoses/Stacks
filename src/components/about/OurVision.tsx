    ...
    <div className="bg-black">
      <div className="container max-w-8xl mx-auto">
        <div className={robotoMono.className}>
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 xl:grid-cols-8 gap-4 py-6 xl:py-24">
            <div className="xl:col-span-4">
              <TextHighlight />
              <p className="text-lg mb-6 text-gray-400 tracking-tight">
            ...
            <div className="xl:col-span-4 flex justify-center pt-10">
