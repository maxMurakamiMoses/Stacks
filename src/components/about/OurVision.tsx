            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 xl:grid-cols-8 gap-4 py-16 xl:py-24">
              <div className="xl:col-span-4">
                ...
                <p className="text-sm text-gray-500 tracking-tight">
                  ...
                  <a href="https://balajis.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500"> Balaji Srinivasan</a> and 
                  <a href="https://www.ldeming.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500"> Laura Deming</a>. 
                  Check them out.
                </p>
              </div>
              <div className="xl:col-span-4 justify-center pt-32 relative z-20">
