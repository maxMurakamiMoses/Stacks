...
import ProfileVoteClientWhite from './ProfileVoteClientWhite'

interface ProfileVoteServerWhiteProps {
  profileId: string
...
const ProfileVoteServerWhite = async ({
  profileId,
  leaderboardId,
  initialUpvotesAmt,
  initialDownvotesAmt,
...
export default ProfileVoteServerWhite
